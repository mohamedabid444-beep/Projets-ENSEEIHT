...
procedure Exemple_Adresse_IP is
	...
	type T_Octet is mod 2 ** 8;			-- entier sur 8 bits de 0 à 255
	type T_Adresse_IP is mod 2 ** 32;	-- entier sur 32 bits
...
begin
	...
	Put (Natural (IP2 mod UN_OCTET));
		-- Conversion d'un T_Adresse_IP en Integer pour utiliser Put(Integer)
	IP2 := IP2 / UN_OCTET;
	Put (Natural (IP2 mod UN_OCTET));
	IP2 := IP2 / UN_OCTET;
	Put (Natural (IP2 mod UN_OCTET));
